...
* Звуковое оповещение о выходе температуры, влажности, CO2 и качества вохдуха за пределы комфорта
...
Альтернативно, можно применить дисплей ILI9341. В этом случае тачскрин дисплея (пока) вообще не работает, соответственно ни графиков, ни больших часов, ни управления будильником на этом дисплее не предусмотрено.
...
Можно подключить любой один, несколько, либо сразу все датчики из этого списка. Если ваш дисплей не **NX4832K035** рекомендуется установить микросхему часов DS3231. Схема подключения следующая.
...
Чтоб будильник и говорящие часы могли издавать звуки, применен модуль mp3-плеера **DF-Player mini**, схема подключения которого представлена ниже. Необходимо будет скопировать все содержимое папки **SDcard** на **micro-sd карту**, предварительно отформатировав ее в файловую систему FAT32. Если вам не нужен звук - соедините вывод GPIO39 ESP32 с землей.
