...
- 1. Добавить самостоятельно, исходники ведь в свободном доступе
- 2. Прислать мне нужный вам датчик/дисплей
- 3. Финансировать добавление нужного вам датчика/дисплея
```
