...
class LcdDisplay : public BaseDisplay {
    protected:
        ...
        uint8_t _icons[5] = {40, 40, 40, 40, 40};
        float _dTemps[5] = {404.0, 404.0, 404.0, 404.0, 404.0};
        float _nTemps[5] = {404.0, 404.0, 404.0, 404.0, 404.0};
        float _winds[5] = {404.0, 404.0, 404.0, 404.0, 404.0};
        float _tempIn = 404.0;
        ...
        uint8_t _prevIcons[5] = {50, 50, 50, 50, 50};
        float _prevDTemps[5] = {504.0, 504.0, 504.0, 504.0, 504.0};
        float _prevNTemps[5] = {504.0, 504.0, 504.0, 504.0, 504.0};
        float _prevWinds[5] = {504.0, 504.0, 504.0, 504.0, 504.0};
