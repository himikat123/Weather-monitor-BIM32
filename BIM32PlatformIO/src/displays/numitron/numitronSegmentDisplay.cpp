...
#include "./numitronSegmentDisplay.hpp"
#include "../../globals.hpp"
 ...
 */
void Numitron::init(uint8_t dispNum, int8_t scl, int8_t sda, int8_t pwm, int8_t ws) {
    _dispNum = dispNum;
    _pwm = pwm;
    _ws = ws;
    pinMode(pwm, OUTPUT);
