...
struct WeatherStruct {
    private:
        ...
        unsigned int _provider = 0; // Weather forecast provider. 0: openweathermap.org, 1: weatherbit.io, 2: open-meteo.com, 3: gismeteo.ru
    ...
    public:
        ...
        unsigned int provider() const { if(_provider > 3) return 0; return _provider; }
