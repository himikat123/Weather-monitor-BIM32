...
#define TFT_MISO 39 //19  // (leave TFT SDO disconnected if other SPI devices share MISO)
#define TFT_MOSI 33 //23
#define TFT_SCLK 32 //18
#define TFT_CS   14 //15  // Chip select control pin
#define TFT_DC    5 //2  // Data Command control pin
