...
void LcdDisplay::_getData() {
    ...
    _netFw = FW;
    _tempIn = agregateData.lcdTempIn(_tempSequence);
    _tempOut = agregateData.lcdTempOut();
    _humIn = agregateData.lcdHumIn(_humSequence);
    _humOut = agregateData.lcdHumOut();
    _presOut = agregateData.lcdPresOut();
    agregateData.lcdSequenceNames(_nameSequence);
    _volt = agregateData.lcdVoltage();
    _voltColor = agregateData.lcdVoltageColor();
    _batLevel = agregateData.lcdBatteryLevel();
    _isApMode = global.apMode;
    _comfort = agregateData.lcdComfort();
    ...
    _windDir = agregateData.lcdWindDirection(weather.get_currentWindDir());
