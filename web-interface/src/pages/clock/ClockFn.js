...
class ClockFn extends Save {
    ...
    clockSyncPC() {
        ...
        this.setState({
            ...
            sendRequest: <Moment format="HH:mm:ss DD.MM.YYYY" date={time}></Moment> 
        });
    ...
    clockSyncManually() {
        ...
        this.setState({
            ...
            sendRequest: <Moment format="HH:mm:ss DD.MM.YYYY" date={this.state.manualTime.replace('T', ' ')}></Moment>
        });
